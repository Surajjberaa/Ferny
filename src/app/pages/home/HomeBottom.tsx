...
function HomeBottom() {
  ...
  return (
    <div className='home-bottom h-[100dvh] w-full flex flex-col md:justify-end justify-start items-center relative'>
      ...
      <div className='flex md:flex-row flex-col justify-between items-end text-center text-black md:h-[30vh] md:pt-0 pt-20 bg-white/10 backdrop-blur-[2px] md:rounded-t-xl rounded-b-xl  w-[80%] h-[50vh]'>
