...
function Landing() {
  ...
  return (
    <div className='landing h-[100dvh] w-full flex flex-col justify-end items-center relative '>
      {
        isMobile ? <img className='object-cover absolute -z-10 opacity-60 h-full w-full' src="https://res.cloudinary.com/dggyfyynb/image/upload/v1746097484/spacejoy-IH7wPsjwomc-unsplash_sey9xy.jpg" alt="" /> : <img className='object-cover absolute -z-10 opacity-60 h-full w-full' src="https://res.cloudinary.com/dggyfyynb/image/upload/v1746022899/spacejoy-trG8989WjFA-unsplash_ppdfww.jpg" alt="" />
      }

      <div className='flex md:flex-row flex-col justify-between items-end text-center h-[30vh]  w-full'>
